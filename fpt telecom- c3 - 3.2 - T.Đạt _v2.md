...
**Biểu đồ ưu tiên rủi ro theo xác suất Gateway giả định** (xếp theo xác suất không đạt giả định của từng Gateway; tổng trọng số = 105%):
...
##### 3.2.3.6.1.1. Câu hỏi có cấu trúc
...
##### 3.2.3.6.1.2. Câu hỏi không cấu trúc
